...
class Ui_datenDialog(object):
    def setupUi(self, datenDialog):
        ...
        self.checkBoxNurOberbergLaden.setGeometry(QRect(80, 200, 331, 23))
        ...
        self.checkBoxCleanOutput.setGeometry(QRect(80, 270, 381, 23))
    ...
    def retranslateUi(self, datenDialog):
        datenDialog.setWindowTitle(QCoreApplication.translate("datenDialog", u"Cebius-Hausnummernprozessor", None))
